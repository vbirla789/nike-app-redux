...
const FlexContent = ({
  ifExists,
  sneaker: { heading, title, img, btn, url, text },
}) => {
  return (
    <div
    ...
    >
      <div className="max-w-lg lg:max-w-none w-full md:text-center">
        ...
        <a
          href={url}
          className="flex items-center md:justify-center mb-4"
          target={"_blank"}
          role="button"
        >
          <button
            type="button"
            className="button-theme bg-slate-900 text-slate-100 shadow-slate-900 py-1.5"
          >
            {btn}
          </button>
        </a>
